...
set ruler
set runtimepath=~/vimfiles,~\\vimfiles\\pack\\kite\\start\\vim-plugin,C:\\Program\ Files\\Vim/vimfiles,C:\\Program\ Files\\Vim\\vim81,C:\\Program\ Files\\Vim\\vim81\\pack\\dist\\opt\\matchit,C:\\Program\ Files\\Vim/vimfiles/after,~/vimfiles/after
set scrolloff=5
set ttimeout
set ttimeoutlen=100
set undofile
...
argglobal
%argdel
$argadd \rust\space_explorer\data\start.txt
set stal=2
tabnew
tabnew
tabnew
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 42 - ((39 * winheight(0) + 30) / 60)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
42
...
normal! 044|
tabnext
edit \rust\space_explorer\data\start.txt
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
set stal=1
badd +1 lib.rs
badd +12 events\mod.rs
badd +1 main.rs
badd +28 C:\Program\ Files\Vim\_vimrc
badd +0 events\general.rs
badd +0 \rust\space_explorer\data\start.txt
